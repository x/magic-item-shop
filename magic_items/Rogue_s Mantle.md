...
***Move in Shadows.*** While you are in [dim light](https://5e.tools/quickreference.html#bookref-quick,2,vision%20and%20light) or darkness, you can use a bonus action to teleport, along with anything you are wearing or carrying, up to 30 feet to an unoccupied space you can see that is also in [dim light](https://5e.tools/quickreference.html#bookref-quick,2,vision%20and%20light) or darkness. You then have advantage on the first melee attack you make before the end of the turn.
